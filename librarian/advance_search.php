						...
						<h1>Books List</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
								  ...
								  $user_query=mysqli_query($mysql,"select * from book where status != 'Archive' and book_title LIKE  '%$title%'
								  OR status != 'Archive' and author LIKE '%$author%'")or die(mysqli_error());
									...
									$borrow_details = mysqli_query($mysql,"select * from borrowdetails where book_id = '$id' and borrow_status = 'pending'");
									...
									echo $total; */
											$cat_query = mysqli_query($mysql,"select * from category where category_id = '$cat_id'")or die(mysqli_error());
