...
<div class="span3">
				...
				<option></option>
				<?php $result =  mysqli_query($mysql,"select * from member")or die(mysqli_error()); 
						...
						<div class="alert alert-success"><strong>Select Book</strong></div>
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($mysql,"select * from book where status != 'Archive' ")or die(mysqli_error());
